...
After the 2026-09-21 DING System Monitor desktop-menu integration was made reproducible and its final DING tree was accepted, the physical workstation completed the current accepted run with:

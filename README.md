...
After the later 2026-09-21 application cleanup removed GNOME Boxes, Fedora Media Writer, and htop from desired state, the physical workstation completed the current accepted run with:

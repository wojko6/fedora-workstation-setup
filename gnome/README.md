...
The custom-location mechanism was physically validated on the Fedora 44 / GNOME 50.5 workstation, including correction of an early coordinate-unit error and a duplicate-name migration edge case. At the Weather-integration checkpoint the full verifier completed with `PASS=231 WARN=0 FAIL=0 SKIP=0`, `VERIFY_RC=0` while the private location file was present. The current project-wide physical baseline is `PASS=256 WARN=0 FAIL=0 SKIP=0`, `VERIFY_RC=0`, refreshed on 2026-09-24 after GSConnect/ddterm v73 promotion, dedicated Tailscale firewalld acceptance, and restoration of the reviewed Dhruva dock state; see `PROJECT-STATUS.md` for the latest aggregate.

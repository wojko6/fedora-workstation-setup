...
- ArcMenu v73 / 69.2 keeps the upstream Polish catalog and applies exact-version runtime fixes for gettext-domain binding plus power-button tooltip translation; it does not carry a duplicate translation catalog.

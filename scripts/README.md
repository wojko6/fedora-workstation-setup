...
- `install-arcmenu-localization.sh` / `verify-arcmenu-localization.sh` — ArcMenu v73 / 69.2 exact-version gettext-domain binding and power-tooltip translation fixes over the upstream Polish catalog; no duplicate repository catalog is installed.

...
- `install-blur-my-shell-localization.sh` / `verify-blur-my-shell-localization.sh` — Blur my Shell v72 46-entry Polish completion over the audited physical EGO catalog.

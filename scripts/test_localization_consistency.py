...
expected = {
    ...
    ("localization/ding/pl.po", "Paste", None): "Wklej",
    ("localization/ding/pl.po", "Select All", None): "Zaznacz wszystko",
    ("localization/ding/pl.po", "Arrange Icons", None): "Rozmieść ikony",
    ("localization/ding/pl.po", "Arrange By...", None): "Sortuj według...",
    ("localization/ding/pl.po", "Show Desktop in Files", None): "Wyświetl pulpit w menedżerze plików",
    ("localization/ding/pl.po", "Change Background…", None): "Zmień tło…",
    ("localization/ding/pl.po", "Desktop Icons Settings", None): "Ustawienia ikon pulpitu",
    ("localization/ding/pl.po", "Display Settings", None): "Ustawienia ekranu",
    ("localization/ding/pl.po", "Keep Arranged...", None): "Autorozmieszczanie",
    ("localization/ding/pl.po", "Keep Stacked by type...", None): "Grupowanie według typu...",
    ("localization/ding/pl.po", "Sort Home/Drives/Trash...", None): "Sortuj katalog domowy/dyski/kosz...",
    ("localization/ding/pl.po", "Sort by Name", None): "Według nazwy",
    ("localization/ding/pl.po", "Sort by Name Descending", None): "Według nazwy malejąco",
    ("localization/ding/pl.po", "Sort by Modified Time", None): "Według daty modyfikacji",
    ("localization/ding/pl.po", "Sort by Type", None): "Według typu",
    ("localization/ding/pl.po", "Sort by Size", None): "Według rozmiaru",

...
- Background Logo
- Browser Switcher
- ArcMenu v73 / 69.2 upstream Polish catalog with repository-managed exact-version gettext-domain binding and power-tooltip translation fixes
...
| --- | --- | --- |
| ArcMenu | Upstream Polish catalog; audited v73 runtime required explicit gettext-domain binding and power-button tooltip retranslation | Exact-version runtime fixes; no duplicate translation catalog |
